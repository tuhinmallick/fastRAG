...
import tqdm
import ujson
from colbert.utility.utils.save_metadata import save_metadata
from colbert.utils.utils import create_directory, groupby_first_item, load_ranking, print_message
...
def main(args):
    ...
    for processing_idx, qid in enumerate(qid2rankings):
        l = sample_for_query(
            qid, qid2rankings[qid], args.positives, args.depth, args.permissive, args.biased
        )
